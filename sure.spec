...
Version  : 1.4.5
Release  : 27
URL      : http://pypi.debian.net/sure/sure-1.4.5.tar.gz
Source0  : http://pypi.debian.net/sure/sure-1.4.5.tar.gz
...
%prep
%setup -q -n sure-1.4.5

%build
export LANG=C
export SOURCE_DATE_EPOCH=1491225659
